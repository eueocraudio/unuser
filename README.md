...
**Estado:** **v1.2.0**. Roadmap (Fases 1–6) concluído + refinos. ~169 testes
...
sudo apt install ./dist/unuserd_1.2.0_all.deb   # cria usuário 'unuser' + /var/lib/unuser/vault
...
sudo apt install ./dist/unuser_1.2.0_amd64.deb  # puxa python3-cryptography/-argon2; blake3 embarcado
```
